...
/*
    What do you think else if and else are doing? Answer in a comment.
        The else if statement will only execute when the previous if statement 
        evaluates false
    ...
    What difference does that make? Why? Answer in a comment. 
        When the else is removed the if statement will be executed regardless
        of how the previous if statement resolves.
*/
package pbd.lesson5;
