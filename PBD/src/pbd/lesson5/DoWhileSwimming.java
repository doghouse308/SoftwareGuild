...
Does Gallant check the water temperature first, or does he just dive right in?
    He checks the temp first.
What about Goofus? Does he check the water temperature first or just dive in?
    He checks the temp after he is in the water.
What is the difference between a while loop and a "do-while" loop?
    The while loop hcecks the conditions first.  The do while loop checks at the
    end of the loop.  The do while loop will alwyas execute at least once.
One of these loops is sometimes called a "pre-test loop", and the other is called
a "post-test loop". Which one is which? 
    The while test is a pre-test loop and the do-while loop is a post test loop.
*/
