...
public class FunctionCallAlphabet {
    ...
    public static void main(String[] args) {
        ...
        f("firefly");    // displays the word you pass it beginning with "F"
        ...
        n("Nutcase");    // displays the word you pass it beginning with "N"
        ...
        t("Twit");    // displays the word you pass it beginning with "T"
        System.out.print(u());    // returns the word to be displayed
        v(3);    // tell it how many times to display the word (1)
