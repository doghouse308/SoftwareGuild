...
public class MoreFillInFunctions {
    ...
    public static void stepcount(int first, int last, int step) // Parameters are:
    //     int first;
    //     int last;
    //     int step;
    {
    ...
    public static int project_grade(int p1, int p2, int p3, int p4, int p5, int p6) // Parameters are:
    ...
    public static String get_name() // No parameters.
    {
